...
public class EvidenceModel {
    ...
    public static EvidenceModel from(IssueEvidence issueEvidence) { return new EvidenceModel(issueEvidence); }
    ...
    public static EvidenceModel from(CandidateEvidence candidateEvidence) { return new EvidenceModel(candidateEvidence); }
}
